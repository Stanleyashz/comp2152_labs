...
input ("Roll the dice for the loot bag (Press enter)")
loot_roll = random.choice(range(1, len(loot_options) + 1))
loot = loot_option.pop(loot_options[loot_roll - 1])
belt.append(loot)
...
#Lab4 Q2 - Row for Monster Power:
input("Roll for the monster's power")
